...
This unique ID was generated by the built-in [`randomUUID()`](https://developer.mozilla.org/en-US/docs/Web/API/Crypto/randomUUID) function which is part of Node.JS [crypto](https://developer.mozilla.org/en-US/docs/Web/API/Crypto) module. You can use any other method to generate your own random string as long as it's very difficult to guess.
